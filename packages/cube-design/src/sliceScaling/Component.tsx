...
import iconBottom from './assets/icon_bottom.png';
...
import iconAll from './assets/icon_all.png';
    ...
    return (
      <div className="index">
        ...
        <div style={{ textAlign: 'center' }}>
          <button className="confirmBtn" onClick={this.onConfirm}>
            CONFIRM
          </button>
        </div>
      </div>
  ...
  render() {
    switch (this.state.curState) {
      case CurState.Loading:
        return <div style={{ marginTop: 100, textAlign: 'center', fontSize: 14 }}>Loading...</div>;
      case CurState.NoSelection:
        return (
          <div style={{ marginTop: 100, textAlign: 'center', fontSize: 14 }}>
